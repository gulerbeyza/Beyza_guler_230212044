...
| `python scripts/train_run.py` | Time-capped fine-tune on that subset |
...
The written project report (PDF) is in the repository root:

- `YAPAY ZEKA MÜHENDİSLİĞİ DERİN ÖĞRENME DERSİ PROJE RAPORU.pdf` — Artificial Intelligence Engineering, Deep Learning course project report.
...
- `datasets/` — prepared COCO subsets and YAMLs (`coco_val5k_beyza.yaml`, `coco128_beyza.yaml`, …)
